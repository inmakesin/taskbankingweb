...
SECRET_KEY = "django-insecure-j*%(oyd2gac#-xt^zh=#==h8(tv47=-w2j=6r^pknerz_x_ev5"
...
# Define the filesystem path where static files will be collected.
...
# Example: os.path.join(BASE_DIR, 'media')
